...
generacion = pd.read_csv("C:\\Users\\Usuario\\Desktop\\Mi ingeniería e. e\\Contenidos por cursos\\Cuarto curso\\Octavo semestre (BOLIVIA)\\RAMP\\excels\\muestra_año_pv_raqaypampa7.csv",header=0)
consumo=pd.read_csv("C:\\Users\\Usuario\\Desktop\\Mi ingeniería e. e\\Contenidos por cursos\\Cuarto curso\\Octavo semestre (BOLIVIA)\\RAMP\\output_file_2.csv")
cap_bat=89 #indica la capacidad de la batería en Wh, puede cambiarse.
