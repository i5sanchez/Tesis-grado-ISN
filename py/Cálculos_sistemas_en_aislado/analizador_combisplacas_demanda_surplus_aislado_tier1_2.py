...
def calcular_y_mostrar_resultados(cap_bat, df, nombre_df):
    ...
    return energia_generada, energia_demandada, surplus_energy, energia_insatisfecha, proporcion_insatisfecha,energia_consumida

#energia_generada, energia_demandada, surplus_energy, energia_insatisfecha, proporcion_insatisfecha = calcular_y_mostrar_resultados(cap_bat, dfs[cat_Pgen])
...
calcular_y_mostrar_resultados_(cap_bat, cat_Pgen1, num_bat, dfs_t1o2_1, "de la vivienda 1 aislada en picogrid")
calcular_y_mostrar_resultados_(cap_bat, cat_Pgen1, num_bat, dfs_t1o2_2, "de la vivienda 2 aislada en picogrid")
calcular_y_mostrar_resultados_(cap_bat, cat_Pgen1, num_bat, dfs_t1o2_3, "de la vivienda 3 aislada en picogrid")
calcular_y_mostrar_resultados_(cap_bat, cat_Pgen1, num_bat, dfs_t1o2_4, "de la vivienda 4 aislada en picogrid")


"""
precio_Bs_base_mes=16.6
energ_mensual= energia_demandada//12
