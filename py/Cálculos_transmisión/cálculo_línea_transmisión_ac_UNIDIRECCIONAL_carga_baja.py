# -*- coding: utf-8 -*-
"""
Created on Fri May 24 17:27:49 2024
...
calc_prec(230, long_cables, cable_1_5mm, 10)
...
for V in range(230, 921, 230):
    ...
    for distancia in range(10, 2500, 10):
        ...
        for cable in cables:
            ...
            precio, _, validez_term, validez_caida, caida_porc,NPC = calc_prec_(V, distancia * 2, cable, 10)
...
plt.ylim(190, max(precios_optimos) + 500)  # Límites en el eje y, ajustado dinámicamente
...
plt.yticks(np.arange(190, max(precios_optimos) + 500, 20))  # Intervalo de 2500 en 2500 USD en el eje y
